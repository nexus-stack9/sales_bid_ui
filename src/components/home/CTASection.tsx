          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className={`transition-all duration-700 ${isInView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              ...
              <p className="mt-6 text-lg text-primary-100">
                Sign up now to access exclusive auction deals and start saving on premium products.
              </p>
              ...
              <div className="mt-8 space-y-4">
                {benefits.map((benefit, index) => (
                  <div 
                    key={index} 
                    className={`flex items-center transition-all duration-500 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
            ...
            <div className={`transition-all duration-1000 ${isInView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
              <div className="relative">
                ...
                <div className="relative bg-white p-8 rounded-2xl shadow-xl">
                  ...
                  <h3 className="font-display text-2xl font-bold mb-4 text-gray-900">New User Special</h3>
                  <p className="text-gray-600 mb-6">Register today and receive:</p>
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-start">
                      <span className="h-6 w-6 rounded-full bg-secondary/20 text-secondary flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">✓</span>
                  ...
                  <Link to="/signup" className="block">
                    <Button className="w-full bg-primary hover:bg-primary-600">Sign Up Now</Button>
                  </Link>
                </div>
              </div>
            </div>
