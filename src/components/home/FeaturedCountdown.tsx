    ...
    <section className="py-16 bg-gradient-to-r from-primary to-primary-dark relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <Badge className="bg-white/20 text-white mb-4">Featured Listing</Badge>
            <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-4">
              Luxury Watch Collection Listing Ending Soon
            </h2>
            <p className="text-white/80 mb-8 text-lg">
              Don't miss your chance to submit an offer on this exclusive collection of premium timepieces from renowned brands. Current price is $4,850.
            </p>
            ...
            <div className="flex items-center mt-6 text-white/70">
              ...
              <span>47 buyers viewing this listing</span>
            </div>
          </div>
