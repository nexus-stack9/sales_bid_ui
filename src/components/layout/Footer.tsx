      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <Link to="/" className="flex items-center space-x-2">
              <div className="flex items-center justify-center rounded-md bg-white text-primary w-8 h-8">
                <span className="font-display text-lg">R</span>
              </div>
              <span className="font-display text-xl font-bold">Renaissance</span>
            </Link>
            <p className="mt-4 text-sm text-primary-foreground/80">
              Renaissance Auctions is a modern marketplace for surplus, salvage, and returned inventory.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/auctions" className="hover:underline">Browse Auctions</Link></li>
              <li><Link to="/how-it-works" className="hover:underline">How It Works</Link></li>
              <li><Link to="/sell" className="hover:underline">Sell With Us</Link></li>
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-lg font-display font-semibold mb-4">Stay Updated</h3>
        ...
        <div className="mt-10 border-t border-white/10 pt-6 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-sm text-primary-foreground/70">
            &copy; {new Date().getFullYear()} Renaissance Auctions. All rights reserved.
          </p>
