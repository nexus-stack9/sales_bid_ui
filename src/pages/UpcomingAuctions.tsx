    ...
    <Layout>
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-3">Upcoming Listings</h1>
          <p className="text-lg text-slate-600">Plan procurement and bookmark upcoming listings you don’t want to miss.</p>
        </div>
