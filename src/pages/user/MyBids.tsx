...
const MyBids = () => {
  ...
  const BidCard = ({ item }: { item: Bid }) => {
    ...
    return (
      <div
        className="w-[calc(100%-32px)] max-w-[400px] sm:max-w-[280px] bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow cursor-pointer mx-auto"
